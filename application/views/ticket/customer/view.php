        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel ticket_div">
                    ...
                    <div class="x_content">
                        <div class="">
                            <input type="hidden" name="ticket_id" id="ticket_id" value="<?php echo $form_data['ticket_id'];?>"/>
                            <div class="clearfix"></div>
...
//                   $('#attchment_list').append()
    ...
    function Popup(data)
    {
        ...
        /*optional stylesheet*/mywindow.document.write('<link rel="stylesheet" href="main.css" type="text/css" /><link href="<?php echo base_url(); ?>assets/css/bootstrap.min.css" rel="stylesheet"><link href="<?php echo base_url(); ?>assets/css/font-awesome.min.css" rel="stylesheet"><link href="<?php echo base_url(); ?>assets/css/animate.min.css" rel="stylesheet"><link href="<?php echo base_url(); ?>assets/css/custom.css" rel="stylesheet"><link href="<?php echo base_url(); ?>assets/css/icheck/flat/green.css" rel="stylesheet">');
