...
<div class="modal fade bs-example-modal-lg printdiv" id="printdiv" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-4 col-sm-6 member-cls">
...
<link rel="stylesheet" type="text/css" media="print" href="http://localhost/checknchange/assets/css/bootstrap.min.css">
<script type="text/javascript">

    function printDiv(ticket_id)
    {
        var divToPrint = "";
        var base_url = $('body').find("#base_url").val();
        console.log('test');
        $.ajax({
            url: base_url + "request/printview/" + ticket_id,
            success: function (res) {
                ...
                newWin.document.write('<link rel="stylesheet" type="text/css" media="print" href="http://localhost/checknchange/assets/css/bootstrap.min.css">');
                newWin.document.write('<body onload="window.print()">' + divToPrint + '</body></html>');
    ...
    $(document).ready(function () {
        ...
        $("body").on('click', '.print', function () {
            var ticket_id = $(this).closest('#printdiv').find('#single_ticket').val();
