<div class="right_col" role="main">
    <div class="container" >
        <div class="">
            ...
            <div class="row">
                <?php if ($this->session->flashdata('history_danger')) : ?>
                    <div class="alert alert-danger">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <?php echo $this->session->flashdata('history_danger'); ?>
                    </div>
                <?php endif; ?>
                <?php if ($this->session->flashdata('history_success')) : ?>
                    <div class="alert alert-success">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <?php echo $this->session->flashdata('history_success'); ?>
                    </div>
                <?php endif; ?>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
					...
					<thead>
						 ...
						 <!--<th>Input</th>-->
						  ...
						  <th></th>
	  <!--                                        <th></th> -->
						  <th><select id="amc_name" class="dropcolor"><option value="">Not Set</option>
							    <?php
						  ...
						  <th><select id="customer_name" class="dropcolor"><option value="">Not Set</option>
							    <?php
						  ...
						  <th><input type="text" class="dropcolor form-control" name="address_search" id="address_search" placeholder="Address"/></th>
						  <th></th>
						  <th>
						       <select id="customer_email" class="dropcolor"><option value="">Not Set</option>
							    <?php
						  ...
						  <th><select id="service_date" class="dropcolor"><option value="">Not Set</option>
							    <?php
						  ...
						  <th><select id="customer_type" class="dropcolor"><option value="">Not Set</option><option value="premium">Premium</option><option value="regular">Regular</option></select></th>
						  <th></th> 
					     </tr>
					</thead>
                                <tbody>
...
<script>
    ...
    $(document).ready(function() {
	  ...
	  $("body").on("keyup", "#address_search", function () {
