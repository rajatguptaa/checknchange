			      ...
			      <form class="form-horizontal form-label-left"  data-parsley-validate action="" method="post" enctype="multipart/form-data">
				   ...
				   <div class='col-md-4 pull-right'>
					<div class="form-group">
					     ...
					     <div class="kv-avatar center-block" style="width:200px">
						  ...
						  <input id="old_image"  value="<?php echo $form_data['user_profile']; ?>" type="hidden" name='old_image'>
						    <br>
						  <a href="<?php echo base_url($form_data['user_profile']); ?>" download class="btn btn-xs btn-success">Download<img src="<?php echo base_url($form_data['user_profile']); ?>" style="display: none"></a>
					...
					<div class="form-group">
					     ...
					     <div class="kv-avatar center-block" style="width:200px">
						  ...
						  <br>
						  <a href="<?php echo base_url($form_data['document']); ?>" download class="btn btn-xs btn-success">Download<img src="<?php echo base_url($form_data['document']); ?>" style="display: none"></a>
				   ...
				   <div class="col-md-8">
					...
					<div class="item form-group">
					     ...
					     <div class="col-md-6 col-sm-6 col-xs-12 ">
						  <input data-parsley-error-message="The Code field is required." id="employee_code" class="form-control col-md-7 col-xs-12 <?= (strlen(form_error('user_code')) > 0) ? "parsley-error" : "" ?>" value="<?= ( $method == "post") ? set_value('user_code') : $form_data['user_code']; ?>" readonly="" name="user_code" placeholder="Employee code" required="required" type="text">
					...
					<div class="item form-group">
					     ...
					     <div class="col-md-6 col-sm-6 col-xs-12">
						  <input type="email"  value="<?= ( $method == "post") ? set_value('user_email') : $form_data['user_email']; ?>"  class="form-control col-md-7 col-xs-12 <?= (strlen(form_error('user_email')) > 0) ? "parsley-error" : "" ?>" placeholder="Email" class="form-control col-md-7 col-xs-12" name="user_email" id="email" >
