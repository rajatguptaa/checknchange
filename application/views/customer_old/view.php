...
<?php endif;?>
                                            <li>
                                                ...
                                                <?php $accese_detail = getUserAccessDetails($user_detail['user_id']);
                                     ...
                                     <?php  if(access_check("customer","edit")): ?>
                                        <a href="<?php echo base_url().'customer/edit/'.$user_detail['user_id']?>" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                                     <?php                                                endif;?> 
                                        <h4>Organisation</h4>
...
<script>
    ...
    function getTicketData(tab_content, ticket_type, user_id) {
        var href = $("#base_url").val() + 'customer/empTicket';
