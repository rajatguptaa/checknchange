...
class Mailbox {
	...
	/**
         ...
         * @throws Exception
         */
	public function __construct($imapPath = IMAP_HOST, $login = SMTP_USERNAME, $password = SMTP_PASSWORD, $attachmentsDir = null, $serverEncoding = 'UTF-8') {
