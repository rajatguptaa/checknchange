   $.fn.formgroup = function () {
            ...
            function init(obj){
                ...
                $(obj).find("optgroup").each(function (index, value) {
                    ...
                    var  field_name = $(".group").attr('name');
                    $(this).find("option").each(function (opt_key, opt_val) {
                         ...
                         selectdoption += '<span class="tag label label-info" id=tag_'+group_id+'>'+text+'<span class="remove_tag" data-role="remove" data-id ='+val+'></span><input style="display:none"  type="text" name="'+field_name+'" value='+val+'_'+group_id+'></span>';               
            }
                         else{
...
option += "</ul>";
                ...
                $(obj).parent().append(oprationObj);
                 ...
                 $('.input_tag').append(selectdoption);
